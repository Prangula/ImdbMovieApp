...
class SearchMoviesPagingSource(
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, MoviesResultDto> {
        ...
        return try {
            val movies = movieResponse(query,page = pageIndex)
    ...
    private suspend fun movieResponse(query:String, page: Int): List<MoviesResultDto>? {
        val movies = moviesApi.getSearchMovies(query,page = page)
